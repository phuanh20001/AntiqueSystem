...
// Load the ABI generated by Hardhat after compilation if available
const artifactPath = path.join(__dirname, '..', 'artifacts', 'contracts', 'AntiqueVerification.sol', 'AntiqueVerification.json');
let contractABI = null;
if (fs.existsSync(artifactPath)) {
  try {
    contractABI = require(artifactPath).abi;
  } catch (error) {
